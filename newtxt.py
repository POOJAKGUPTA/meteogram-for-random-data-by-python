...
print ("required plot \n press 1 for single plot \n press 2 for multiple plot")

required_plot=int(raw_input())

if required_plot==1:

        print ("please enter your choice : \n for precipitation press 1 \n for temperature and relative_humidity press 2 \n for wind speed and wind direction press 3 \n for surface_air_pressure press 4 \n")
...
if choice ==1:
    ax1=plt.subplot2grid((1,1), (0,0) , rowspan=2, colspan=1, label='ppt')
...
if choice ==4:
   ax4=plt.subplot2grid((1,1), (0,0) , rowspan=2, colspan=1)
